...
module MainBlock_wrapper
  ...
  wire [1:1]ADC_SPI_ss_i_1;
  wire [0:0]ADC_SPI_ss_io_0;
  wire [1:1]ADC_SPI_ss_io_1;
  wire [0:0]ADC_SPI_ss_o_0;
  wire [1:1]ADC_SPI_ss_o_1;
  wire ADC_SPI_ss_t;
  wire [0:0]ADC_nRST_tri_o;
  wire [2:0]RGB_LED1_tri_o;
  wire [0:0]RGB_LED2_tri_i_0;
  wire [1:1]RGB_LED2_tri_i_1;
  wire [2:2]RGB_LED2_tri_i_2;
  wire [0:0]RGB_LED2_tri_io_0;
  wire [1:1]RGB_LED2_tri_io_1;
  wire [2:2]RGB_LED2_tri_io_2;
  wire [0:0]RGB_LED2_tri_o_0;
  wire [1:1]RGB_LED2_tri_o_1;
  wire [2:2]RGB_LED2_tri_o_2;
  wire [0:0]RGB_LED2_tri_t_0;
  wire [1:1]RGB_LED2_tri_t_1;
  wire [2:2]RGB_LED2_tri_t_2;
  ...
  MainBlock MainBlock_i
       (.ADC_SPI_io0_i(ADC_SPI_io0_i),
        ...
        .ADC_SPI_ss_i({ADC_SPI_ss_i_1,ADC_SPI_ss_i_0}),
        .ADC_SPI_ss_o({ADC_SPI_ss_o_1,ADC_SPI_ss_o_0}),
        .ADC_SPI_ss_t(ADC_SPI_ss_t),
        .ADC_nRST_tri_o(ADC_nRST_tri_o),
        .RGB_LED1_tri_o(RGB_LED1_tri_o),
        .RGB_LED2_tri_i({RGB_LED2_tri_i_2,RGB_LED2_tri_i_1,RGB_LED2_tri_i_0}),
        .RGB_LED2_tri_o({RGB_LED2_tri_o_2,RGB_LED2_tri_o_1,RGB_LED2_tri_o_0}),
        .RGB_LED2_tri_t({RGB_LED2_tri_t_2,RGB_LED2_tri_t_1,RGB_LED2_tri_t_0}),
  ...
  IOBUF RGB_LED2_tri_iobuf_0
       (.I(RGB_LED2_tri_o_0),
        .IO(RGB_LED2_tri_io[0]),
        .O(RGB_LED2_tri_i_0),
        .T(RGB_LED2_tri_t_0));
  IOBUF RGB_LED2_tri_iobuf_1
       (.I(RGB_LED2_tri_o_1),
        .IO(RGB_LED2_tri_io[1]),
        .O(RGB_LED2_tri_i_1),
        .T(RGB_LED2_tri_t_1));
  IOBUF RGB_LED2_tri_iobuf_2
       (.I(RGB_LED2_tri_o_2),
        .IO(RGB_LED2_tri_io[2]),
        .O(RGB_LED2_tri_i_2),
        .T(RGB_LED2_tri_t_2));
