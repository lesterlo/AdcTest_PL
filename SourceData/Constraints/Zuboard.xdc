...
set_property -dict { PACKAGE_PIN E5 IOSTANDARD LVCMOS18 } [get_ports ZUB_Click_SPI_io0_io ];
...
# RGB Light
set_property -dict { PACKAGE_PIN B5 IOSTANDARD LVCMOS18 } [get_ports { RGB_LED_1_tri_o[0] }]; #HD_GPIO_RGB1_B
set_property -dict { PACKAGE_PIN B6 IOSTANDARD LVCMOS18 } [get_ports { RGB_LED_1_tri_o[1] }]; #HD_GPIO_RGB1_G
set_property -dict { PACKAGE_PIN A7 IOSTANDARD LVCMOS18 } [get_ports { RGB_LED_1_tri_o[2] }]; #HD_GPIO_RGB1_R
set_property -dict { PACKAGE_PIN F4 IOSTANDARD LVCMOS18 } [get_ports { RGB_LED_2_tri_o[0] }]; #HD_GPIO_RGB2_B
set_property -dict { PACKAGE_PIN A2 IOSTANDARD LVCMOS18 } [get_ports { RGB_LED_2_tri_o[1] }]; #HD_GPIO_RGB2_G
set_property -dict { PACKAGE_PIN B4 IOSTANDARD LVCMOS18 } [get_ports { RGB_LED_2_tri_o[2] }]; #HD_GPIO_RGB2_R